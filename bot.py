import os
import logging
from utils.config import validate_config, BOT_TOKEN
import tempfile
...
# Error handler to log uncaught exceptions from handlers
from telegram import Update
from telegram.ext import ContextTypes

async def error_handler(update: object, context: ContextTypes.DEFAULT_TYPE) -> None:
    logging.exception('Unhandled exception in handler: %s', context.error)
